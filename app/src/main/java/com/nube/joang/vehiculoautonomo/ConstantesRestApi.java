...
public final class ConstantesRestApi {
    ...
    public static final String KEY_GET_STOPENGINE = "startEngine/?startEngine=false";
    public static final String URL_GET_STARTENGINE = ROOT_URL + REST_API + KEY_GET_STARTENGINE;
    public static final String URL_GET_STOPENGINE = ROOT_URL + REST_API + KEY_GET_STOPENGINE;
}
